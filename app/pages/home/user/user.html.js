...
/**/) {
var buf = [];
var locals_ = (locals || {}),user = locals_.user;buf.push("<span class=\"account-name\">" + (jade.escape(null == (jade.interp = user.name ) ? "" : jade.interp)) + "</span><a tabindex=\"0\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\" aria-owns=\"tmpst-header-about-popup\" data-popup=\"#tmpst-header-about-popup\" data-popup-bind-open=\"mouseenter\" data-popup-item=\"a\" data-popup-direction=\"se\" class=\"tmpst-header-link tmpst-header-account\">关于&nbsp;▾</a>|<a" + (jade.attrs({ 'href':('' + (user.logoutUrl) + '') }, {"href":true})) + ">logout</a><div id=\"tmpst-header-about-popup\" class=\"hide tmpst-header-popup\"><a data-popup-close=\"data-popup-close\" href=\"/\" class=\"internal-home\">Home</a><a data-popup-close=\"data-popup-close\" href=\"/about\" class=\"internal-home\">About</a></div>");;return buf.join("");
}
};
